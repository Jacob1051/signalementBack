...
insert into Signalement values(null, 1, 1, 'Tady ho rodana le trano le1', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Tady ho rodana le trano io zoky a1', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Ratsy be le lalana1', now(), 1,1);

insert into Signalement values(null, 1, 1, 'Tady ho rodana le trano le2', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Tady ho rodana le trano io zoky a2', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Ratsy be le lalana2', now(), 1,1);

insert into Signalement values(null, 1, 1, 'Tady ho rodana le trano le3', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Tady ho rodana le trano io zoky a3', now(), 1,1);
insert into Signalement values(null, 2, 1, 'Ratsy be le lalana3', now(), 1,1);
CREATE TABLE Valide(
