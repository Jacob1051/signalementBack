...
<%
    int pagination = 10;
    ArrayList<Signalement> listes = new Signalement().getSignalementNonRepondu(application.getAttribute("connexion"), "0", "10");
%>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="col-lg-3 col-sm-3 col-3">
                            <a class="btn bg-gradient-success w-100 mb-0 toast-btn" type="button" href="${pageContext.request.contextPath}/traite/validation.jsp?id=<%= listes.get(i).getId()%>&i=1">Accept</a>
                          <a class="btn bg-gradient-danger w-100 mb-0 toast-btn" type="button" href="${pageContext.request.contextPath}/traite/validation.jsp?id=<%= listes.get(i).getId()%>&o=1">Refuse</a>
                        </div>
                      </td>
                    </tr>
                    <%
